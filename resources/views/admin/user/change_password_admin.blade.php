                        ...
                        <div class="row">
                            <div class="col-lg-12">  
                                <div class="form-group row">
                                    {!! Form::label('New Password', 'New Password',['class'=>'col-sm-3 col-form-label font-weight-bolder']) !!}
                                    <div class="col-sm-9">
                            ...
                            <div class="col-lg-12 ">
                                <div class="form-group row">
                                    {!! Form::label('Confirm Password', 'Confirm Password',['class'=>'col-sm-3 col-form-label font-weight-bolder']) !!}
                                    <div class="col-sm-9">
                                        <div class="pass-group">
...
$(document).ready(function() {
    ...
    $(function() {
        ...
        $('#customer-user-updatepassword-form').validate({
            ignore: '.ignore',
            focusInvalid: false,
            rules: {
                'newpassword': {
